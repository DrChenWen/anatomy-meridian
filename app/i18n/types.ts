...
/** Prose for one meridian / channel / vessel. */
export type OrganContent = {
  ...
  // TCM fields (used in zh/en locales)
  yinYang?: string;
  primaryOrgan?: string;
  element?: string;
  peakTime?: string;
  keyPoint?: string;
  // Legacy anatomy fields (used in other locales)
  size?: string;
  weight?: string;
  bloodSupply?: string;
};

export type OrganContentDictionary = Partial<Record<OrganId, OrganContent>> & Record<string, OrganContent>;
...
export type UiDictionary = {
  ...
  info: {
    ...
    yinYang?: string; element?: string; peakTime?: string; keyPoint?: string;
  };
